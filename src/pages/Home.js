    ...
    return (
        <Container fluid className="h-100">
            ...
            <Row className="text-center opn align-items-center">
                <Col xs={0} sm={0} md={1} lg={3} xl={3} className="opnSides"></Col>
                <Col xs={12} sm={12} md={10} lg={6} xl={6} className="opnM">
                    <Row>

                        <Col xs={12} sm={12} md={12} lg={12} xl={12} className="mt-3 bot-text">
                            <Image src='cosmoBot.png' width={100} className="mt-2 mb-2"></Image>
                            <p>
